export default function Lab1() {
    return (
        <div>
            ...
            <div id="wd-p-tag">
                <h4>Paragraph Tag</h4>
                <p id="wd-p-1"> This is a paragraph. We often separate a long set of sentences with vertical
                    ...
                    to add vertical spacing, wrap the paragraphs you want to separate with the paragraph tag </p>
                <p id="wd-p-2">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Serve with crackers, bread, vegetables, or part of a dish and enjoy!.</li>
                </ol>
            ...
            Nulla at augue scelerisque, imperdiet tellus id, ornare lorem. Etiam sit amet consequat dui. Cras malesuada,
            purus id placerat imperdiet, sem ex aliquet tortor, vitae dictum dui ligula ut sem. Duis gravida id ipsum non dictum.
            Nam euismod, sapien ac feugiat pharetra, sapien odio dictum elit, nec tempor metus mi ac nulla. </textarea>
            ...
            Please
            <a href="https://github.com/luanaaas/kambaz-react-web-app" id="wd-github">click here</a> for my code repository on GitHub.
